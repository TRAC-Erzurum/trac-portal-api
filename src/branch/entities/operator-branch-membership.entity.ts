...
@Entity('operator_branch_memberships')
@Unique(['operatorId', 'branchId'])
export class OperatorBranchMembership extends BaseEntity {
  ...
  @ManyToOne(() => Operator, { nullable: false, onDelete: 'CASCADE' })
